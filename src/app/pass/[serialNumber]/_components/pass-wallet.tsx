  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-6">
      <div className="flex flex-col items-center gap-10 w-full max-w-2xl text-center">
        ...
        <div className={`grid gap-4 w-full ${googleSaveUrl ? 'grid-cols-1 sm:grid-cols-2' : 'grid-cols-1 max-w-xs mx-auto'}`}>

          {/* Apple Wallet */}
          <div className="flex flex-col items-center gap-4 rounded-2xl border bg-card p-6">
            <div className="flex items-center gap-2">
              <AppleIcon />
              <span className="text-sm font-semibold">Apple Wallet</span>
            </div>
